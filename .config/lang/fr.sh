...
# fr.sh - Fichier de langue française pour le serveur Plutonium Call of Duty: Black Ops
# Version: 1.0.0
# Auteur: Sterbweise
...
# d'installation, de gestion et de désinstallation du serveur Plutonium Call of Duty: Black Ops.
